...
| [x]  | 4  | Remove Duplicates from Sorted Array    | [Link](https://leetcode.com/problems/remove-duplicates-from-sorted-array/)           | [Step3_Arrays/3.1_Easy/remove_duplicates.py](Step3_Arrays/3.1_Easy/remove_duplicates.py) | Two-pointer method                    |
...
| [ ]  | 6  | Left Rotate by D Places                | [Link](https://leetcode.com/problems/rotate-array/)                                  | [Step3_Arrays/3.1_Easy/left_rotate_d.py](Step3_Arrays/3.1_Easy/left_rotate_d.py)        | Use reversal algorithm or temp array  |
| [ ]  | 7  | Move Zeros to End                      | [Link](https://leetcode.com/problems/move-zeroes/)                                   | [Step3_Arrays/3.1_Easy/move_zeros.py](Step3_Arrays/3.1_Easy/move_zeros.py)              | Two-pointer or count-zero approach    |
...
| [ ]  | 9  | Intersection of Two Arrays             | [Link](https://leetcode.com/problems/intersection-of-two-arrays/)                    | [Step3_Arrays/3.1_Easy/intersection.py](Step3_Arrays/3.1_Easy/intersection.py)          | Use set/hashmap or two pointers       |

### 📂 3.1: Binary Search on Arrays

| ✅   | #  | Problem                          | LeetCode Link                                                                 | Solution                                                                 | Notes                                  |
|------|----|----------------------------------|-------------------------------------------------------------------------------|--------------------------------------------------------------------------|----------------------------------------|
| [ ]  | 1  | Binary Search on 1D Array        | [Binary Search](https://leetcode.com/problems/binary-search/)                 | [binary_search.py](Step3_Arrays/3.1_BinarySearch/binary_search.py)       | Classic binary search, O(log n)        |
| [ ]  | 2  | Upper Bound / Lower Bound        | [Search Insert Position](https://leetcode.com/problems/search-insert-position/) | [lower_upper_bound.py](Step3_Arrays/3.1_BinarySearch/lower_upper_bound.py) | Variants of binary search              |
| [ ]  | 3  | First and Last Occurrence        | [Find First and Last Position](https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array/) | [first_last_occurrence.py](Step3_Arrays/3.1_BinarySearch/first_last_occurrence.py) | Two binary searches                   |
| [ ]  | 4  | Search in Rotated Sorted Array I | [Search in Rotated Sorted Array](https://leetcode.com/problems/search-in-rotated-sorted-array/) | [search_rotated_array.py](Step3_Arrays/3.1_BinarySearch/search_rotated_array.py) | Pivot + binary search                  |
| [ ]  | 5  | Search in Rotated Sorted Array II| [Search in Rotated Sorted Array II](https://leetcode.com/problems/search-in-rotated-sorted-array-ii/) | [search_rotated_array_ii.py](Step3_Arrays/3.1_BinarySearch/search_rotated_array_ii.py) | Handle duplicates                     |
| [ ]  | 6  | Single Element in Sorted Array  | [Single Element in a Sorted Array](https://leetcode.com/problems/single-element-in-a-sorted-array/) | [single_element.py](Step3_Arrays/3.1_BinarySearch/single_element.py)     | XOR or binary search on pairs          |
| [ ]  | 7  | Find Peak Element               | [Find Peak Element](https://leetcode.com/problems/find-peak-element/)          | [find_peak.py](Step3_Arrays/3.1_BinarySearch/find_peak.py)               | Binary search on slopes                |
| [ ]  | 8  | Search in 2D Matrix             | [Search a 2D Matrix](https://leetcode.com/problems/search-a-2d-matrix/)        | [search_2d_matrix.py](Step3_Arrays/3.1_BinarySearch/search_2d_matrix.py) | Treat matrix as flattened array        |
| [ ]  | 9  | Search in 2D Matrix II          | [Search a 2D Matrix II](https://leetcode.com/problems/search-a-2d-matrix-ii/)  | [search_2d_matrix_ii.py](Step3_Arrays/3.1_BinarySearch/search_2d_matrix_ii.py) | Start from corner, O(m+n)              |
